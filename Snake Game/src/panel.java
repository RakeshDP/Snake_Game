...
public class panel extends JPanel implements ActionListener{
    ...
    //to store x and y coordinate of the snake
    ...
    panel() {
        ...
        //this command allows keyboard input to be process
    ...
    public void draw(Graphics graphic) {
        ...
        public void move(){
        //Update all the body parts except the head
        for(int i =length; i >0; i--){
            xsnake[i] = xsnake[i-1];
            ysnake[i] = ysnake[i-1];
        }
